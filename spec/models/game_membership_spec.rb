  ...
  describe "update_lives" do
    context "with predictions" do
      ...
      let!(:correct_prediction) do
        FactoryGirl.create(:prediction, game: game, user: user, fixture: fixture_a, team: essendon)
      end

      let!(:incorrect_prediction) do
        FactoryGirl.create(:prediction, game: game, user: user, fixture: fixture_b, team: hawthorn)
      end
