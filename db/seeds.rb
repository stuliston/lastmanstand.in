...
User.destroy_all
Profile.destroy_all
stu = User.create!(email: 'stuart.liston@gmail.com', password: 'password', password_confirmation: 'password', profile: Profile.new(name: 'Stu'))
rob = User.create!(email: 'robmonie@gmail.com', password: 'password', password_confirmation: 'password', profile: Profile.new(name: 'Rob'))
phil = User.create!(email: 'metcalfe.phil@gmail.com', password: 'password', password_confirmation: 'password', profile: Profile.new(name: 'Phil'))
ash = User.create!(email: 'ash@ashmckenzie.org', password: 'password', password_confirmation: 'password', profile: Profile.new(name: 'Ash'))
dan = User.create!(email: 'locusdelicti@gmail.com', password: 'password', password_confirmation: 'password', profile: Profile.new(name: 'Dan'))
